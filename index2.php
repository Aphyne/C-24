...
<div class="row mt-4">
  <div class="col">
    <div class="alert alert-info shadow-sm">
      <h5 class="mb-2"><i class="fas fa-bell"></i> Alert & Notifikasi Strategis</h5>
      <ul class="mb-0">
        <li>🔴 <strong>Paracetamol</strong> stok tinggal <strong>5 strip</strong> – segera lakukan pemesanan ulang.</li>
        <li>🕒 Waktu tunggu tertinggi hari <strong>Jumat pukul 18:00</strong> – pertimbangkan tambahan tenaga medis.</li>
        <li>📉 Pemeriksaan harian menurun selama 3 hari berturut-turut.</li>
        <li>⚠️ Dokter A tidak hadir hari ini – sesuaikan jadwal pemeriksaan.</li>
      </ul>
    </div>
  </div>
</div>

<!-- ROW 4: Grafik Tren 7 Hari -->
<div class="row mt-4">
  <div class="col">
    <div class="card shadow-sm">
      <div class="card-header bg-light font-weight-bold text-primary">
        Tren 7 Hari Terakhir: Pasien, Pemeriksaan, Pengeluaran
      </div>
      <div class="card-body">
...
<!-- ROW 5: Aktivitas Hari Ini -->
<div class="row mt-4">
  <div class="col-md-3">
    <div class="card bg-info text-white text-center py-3 shadow">
      <h6>Pasien Hari Ini</h6>
      <h4>28</h4>
    </div>
  </div>
  <div class="col-md-3">
    <div class="card bg-success text-white text-center py-3 shadow">
      <h6>Pemeriksaan Selesai</h6>
      <h4>22</h4>
    </div>
  </div>
  <div class="col-md-3">
    <div class="card bg-primary text-white text-center py-3 shadow">
      <h6>Dokter Aktif</h6>
      <h4>5</h4>
    </div>
  </div>
  <div class="col-md-3">
    <div class="card bg-warning text-white text-center py-3 shadow">
...
<div class="row mt-4">
  <div class="col-md-6">
    <div class="card shadow-sm">
      <div class="card-header bg-light font-weight-bold text-primary">
        Kalender Mini (Agenda Hari Ini)
      </div>
      <div class="card-body">
        <ul class="mb-0">
          <li>🩺 08:00 - Shift Pagi Dokter A</li>
          <li>💉 10:00 - Penyuluhan Imunisasi</li>
          <li>🧾 13:00 - Audit Internal</li>
          <li>💊 15:00 - Pengadaan Obat Mingguan</li>
        </ul>
      </div>
    </div>
  </div>

<!-- ROW 7: Shortcut Tindakan Cepat -->
  <div class="col-md-6">
    <div class="card shadow-sm">
      <div class="card-header bg-light font-weight-bold text-primary">
        Tindakan Cepat
      ...
      <div class="card-body d-flex flex-wrap gap-3">
        <a href="pemeriksaan/tambah.php" class="btn btn-outline-primary btn-block w-100 mb-2">➕ Tambah Pemeriksaan</a>
        <a href="data-pasien/ulasan.php" class="btn btn-outline-secondary btn-block w-100 mb-2">📄 Lihat Ulasan Pasien</a>
        <a href="data-obat/stok_kritis.php" class="btn btn-outline-danger btn-block w-100 mb-2">📦 Obat Stok Kritis</a>
        <a href="keuntungan/keuntungan.php" class="btn btn-outline-success btn-block w-100">📈 Keuntungan Bulanan</a>
      </div>
    </div>
  </div>
</div>
