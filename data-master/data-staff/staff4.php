...
<head>
    ...
    <title>Poli Klinik | Data Master - Staff</title>
                        ...
                        <?php if ($_SESSION["jabatan"] == 'admin') : ?>
                            ...
                            <div class="collapse" id="data-master" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="staff.php">Data Staff</a>
                                </nav>
                            </div>
        ...
        <div id="layoutSidenav_content" class="bg-white text-dark">
            <main>
                <div class="container-fluid">
                    ...
                    <!-- 🟣 Row 3: Top Performa Staff - GUNAKAN KODE ASLI -->
                    <?php
$staffPerformance = [
    [
        "nama" => "Suster Ayu",
        ...
        <div class="card shadow-sm h-100 position-relative" style="border-radius:18px;">
            ...
            <div class="card-body pb-2">
                ...
                <div class="progress mb-2" style="height:9px;">
                    <div class="progress-bar bg-success" data-width="<?= round(($staff['jam_kerja'] / $staff['target_jam']) * 100) ?>" style="width: 0%;"></div>
                </div>
                <!-- Kehadiran -->
                <div class="mb-2" style="font-size:0.98rem;">
                ...
                <div class="progress mb-2" style="height:9px;">
                    <div class="progress-bar bg-info" data-width="<?= $staff['kehadiran'] ?>" style="width: 0%;"></div>
                </div>
                <!-- Shift & Lembur -->
                <div class="mb-2" style="font-size:0.98rem;">
